...
function iniciarApp(){
    ...
    tabs();//Cambia la seccion cuando se presione el navegador
...
function mostrarSeccion(){
    //Ocultar la seccion que tenga esta clase
...
function seleccionarServicio(servicio){
    ...
    //Comprobar si un servicio se esta seleccionando
...
function mostrarResumen(){
    ...
    if(Object.values(cita).includes('')|| cita.servicios.legnt===0){
    ...
    //Heading para el resumen de los servicios
    const headingServicios=document.createElement('H3');
    headingServicios.textContent='Resumen del turno solicitado';
    ...
    try{
        ...
        if(resultado.resultado){
            Swal.fire({
                ...
                text: 'Tu turno fue creado correctamente, te esperamos!',
                button: 'OK'
            }).then(()=>{
